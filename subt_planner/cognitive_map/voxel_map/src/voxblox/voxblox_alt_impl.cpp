...
VoxelStatus VoxbloxMapBackend<SDFServerType, SDFVoxelType>::getBoxStatus(
...
template <typename SDFServerType, typename SDFVoxelType>
VoxelStatus VoxbloxMapBackend<SDFServerType, SDFVoxelType>::getPathStatus(
...
template <typename SDFServerType, typename SDFVoxelType>
void VoxbloxMapBackend<SDFServerType, SDFVoxelType>::getScanStatus(
...
template <typename SDFServerType, typename SDFVoxelType>
void VoxbloxMapBackend<SDFServerType, SDFVoxelType>::getScanStatusIterative(
    Eigen::Vector3d& pos, std::vector<Eigen::Vector3d>& multiray_endpoints,
    std::tuple<int, int, int>& gain_log,
    std::vector<std::pair<Eigen::Vector3d, VoxelStatus>>& voxel_log,
    SensorParamsBase& sensor_params) {
