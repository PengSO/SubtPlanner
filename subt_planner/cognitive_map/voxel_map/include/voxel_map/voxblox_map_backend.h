#ifndef VOXBLOX_MAP_BACKEND_H_
#define VOXBLOX_MAP_BACKEND_H_
...
#include "voxel_map/voxel_map_utils.h"

#define use_tsdf

#ifdef use_tsdf
typedef voxblox::TsdfServer VoxbloxMapServer;
typedef voxblox::TsdfVoxel VoxbloxMapVoxel;
#else
typedef voxblox::EsdfServer VoxbloxMapServer;
typedef voxblox::EsdfVoxel VoxbloxMapVoxel;
#endif
...
class VoxbloxMapBackend {
 public:
  VoxbloxMapBackend(ros::NodeHandle& nh,
...
// Helper
template class VoxbloxMapBackend<VoxbloxMapServer,
                                 VoxbloxMapVoxel>;
