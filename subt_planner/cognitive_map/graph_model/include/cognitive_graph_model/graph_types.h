...
// #include "cognitive_graph_model/voxel_map.h"
...
enum struct VertexType {
  ...
  kDeadZone = 3   // Low-gain terminal region to avoid revisiting.
};
...
struct Vertex {
  ...
  bool is_leaf_vertex;
  // True when the vertex is supported by reliable nearby map evidence.
  bool is_hanging;
  // Type of vertex in the cognitive graph.
  VertexType type;
