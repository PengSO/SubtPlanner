...
enum BoundedSpaceType { kCuboid = 0, kSphere, kCylinder };
...
struct PlanningParams {
  ...
  // Vertical offset used when anchoring the current UAV state into the topological graph.
  double topological_anchor_z_offset;
  // Clearing free space before planning (deprecated)
  ...
  bool local_path_smoothing_enable;
  int local_path_smoothing_iterations;
  double local_path_smoothing_min_segment;
  // Global planner
  ...
  double local_navigation_min_clearance;
  double local_navigation_clearance_weight;
  double local_navigation_min_path_length;
  double active_homing_update_radius;
  bool local_navigation_recovery_enable;
  int local_navigation_recovery_max_attempts;
  double local_navigation_recovery_distance;
  int max_num_low_gain_iters;
  bool freespace_cloud_enable;
  bool axis_guided_sampling_enable;
  bool disable_local_sample_guidance;
  int sample_candidate_batch_size;
  double axis_biased_sampling_ratio;
  double axis_biased_lateral_scale;
  double axis_biased_backward_scale;
  double sample_axis_alignment_weight;
  double sample_clearance_weight;
  double sample_goal_alignment_weight;
  double sample_same_zone_bonus;
  bool opening_frontier_seed_enable;
  int opening_frontier_seed_max_num;
  int opening_frontier_seed_angle_bins;
  double opening_frontier_seed_min_free_length;
  double opening_frontier_seed_unknown_depth;
  double opening_frontier_seed_min_angle_sep;
  double opening_frontier_seed_min_clearance;
  double opening_frontier_seed_search_radius;
  bool fine_gain_evaluation_enable;
  int fine_gain_top_k;
  double fine_gain_candidate_ratio;
  bool zone_partition_enable;
  int zone_partition_rows;
  int zone_partition_cols;
  double zone_cross_penalty;
  double zone_same_region_bonus;
  bool global_frontier_stickiness_enable;
  double global_frontier_stickiness_ratio;
  bool branch_repositioning_selection_enable;
  int branch_repositioning_region_count;
  double branch_repositioning_memory_alpha;
  double branch_repositioning_frontier_scale_weight;
  double branch_repositioning_compactness_weight;
  double branch_repositioning_success_weight;
  double branch_repositioning_time_weight;
  bool dead_zone_escape_enable;
  int dead_zone_min_low_gain_iters;
  int dead_zone_max_branch_degree;
  double dead_zone_front_clearance;
  double dead_zone_region_radius;
  double dead_zone_penalty_lambda;
  double dead_zone_turn_radius;
  double dead_zone_turn_clearance;
  double dead_zone_turn_step;
  double dead_zone_escape_prefix_length;
  bool shortcut_edges_enable;
  double shortcut_edge_radius;
  double shortcut_detour_ratio;
