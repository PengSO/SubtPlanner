#ifndef SUBTPLANNER_H_
#define SUBTPLANNER_H_
#include <ros/ros.h>
...
class SubtPlanner {
 public:
  ...
  SubtPlanner(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private);
  SubtPlanner(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private,
            VoxelMap* voxel_map);
  ...
  LocalExplorationPlanner::LocalPlannerStatus getExplorationPath();
  LocalExplorationPlanner::LocalPlannerStatus getLocalNavigationPath();
  LocalExplorationPlanner::GlobalPlannerStatus getGlobalExplorationPath();
  ...
  LocalExplorationPlanner* local_explorer_;
 ...
 private:
  ...
  ros::ServiceServer planner_clear_exclusion_zones_service_;
  ...
  ros::ServiceServer planner_enable_exclusion_zone_subscriber_service_;
  ...
  ros::Subscriber exclusion_zone_subscriber_;
  ...
  bool clearExclusionZones(std_srvs::Trigger::Request& req,
  ...
  // Goes to the topological-map vertex closest to the given waypoint.
  ...
  bool plannerEnableExclusionZoneSubscriberCallback(
  ...
  SubtPlanner::PlannerStatus getPlannerStatus();
};
