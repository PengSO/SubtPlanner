...
class PlannerControlInterface {
 ...
 private:
  ...
  ros::Publisher global_revisit_log_pub_;
  ...
  // Mission visualization publisher
  ...
  bool global_revisit_active_ = false;
  ros::Time global_revisit_start_time_;
  ros::Time last_global_revisit_publish_time_;
  double total_global_revisit_time_s_ = 0.0;
  double total_global_revisit_distance_m_ = 0.0;
  double active_global_revisit_distance_m_ = 0.0;
  double last_global_revisit_distance_m_ = 0.0;
  std::uint64_t total_global_revisit_count_ = 0;
  bool last_global_revisit_pose_valid_ = false;
  geometry_msgs::Point last_global_revisit_pose_;
  PCIManager::PCIStatus previous_pci_status_ = PCIManager::PCIStatus::kReady;
  ...
  void publishPlannerStatus(const planner_msgs::planner_srv::Response& res,
                            bool success);
  void beginGlobalRevisitTiming();
  void endGlobalRevisitTiming(const ros::Time& stamp);
  void updateGlobalRevisitDistance();
  void publishGlobalRevisitLog(double last_duration_s = 0.0);
