...
class PCIGeneral : public PCIManager {
 ...
 private:
  ...
  double path_progress_timeout_;
  ros::Time last_path_progress_time_;
  double best_waypoint_distance_ = std::numeric_limits<double>::infinity();
  double best_waypoint_yaw_error_ = std::numeric_limits<double>::infinity();
  double best_waypoint_pitch_error_ = std::numeric_limits<double>::infinity();
  int progress_waypoint_ind_ = -1;
  ...
  double z_offset_a_ = 0.0;
  double z_offset_b_ = 0.0;
