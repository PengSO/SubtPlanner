...
void TsdfServer::getServerConfigFromRosParam(
  ...
  nh_private_.param("pointcloud_queue_size", pointcloud_queue_size_,
                   pointcloud_queue_size_);
  nh_private_.param("enable_icp", enable_icp_, enable_icp_);
  nh_private_.param("accumulate_icp_corrections", accumulate_icp_corrections_,
                   accumulate_icp_corrections_);

  nh_private_.param("occupancy_min_distance_voxel_size_factor",
