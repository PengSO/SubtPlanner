...
InteractiveSlider::InteractiveSlider(
  ...
  interactive_marker.pose.position.x = static_cast<double>(initial_position.x());
  interactive_marker.pose.position.y = static_cast<double>(initial_position.y());
  interactive_marker.pose.position.z = static_cast<double>(initial_position.z());
