  ...
  else
  {
    switch(status)
    {
      ...
      case NodeStatus::SKIPPED:
        return "\x1b[34mSKIPPED\x1b[0m";
      case NodeStatus::IDLE:
        return "\x1b[36mIDLE\x1b[0m";
    }
  }
  return "Undefined";
}
...
template <> int8_t  convertFromString<int8_t>(StringView str)  { return ConvertWithBoundCheck<int8_t>(str); }
template <> int16_t convertFromString<int16_t>(StringView str) { return ConvertWithBoundCheck<int16_t>(str); }
template <> int32_t convertFromString<int32_t>(StringView str) { return ConvertWithBoundCheck<int32_t>(str); }
template <> uint8_t  convertFromString<uint8_t>(StringView str)  { return ConvertWithBoundCheck<uint8_t>(str); }
template <> uint16_t convertFromString<uint16_t>(StringView str) { return ConvertWithBoundCheck<uint16_t>(str); }
template <> uint32_t convertFromString<uint32_t>(StringView str) { return ConvertWithBoundCheck<uint32_t>(str); }
...
PortDirection convertFromString<PortDirection>(StringView str)
{
  ...
  if(str == "InOut" || str == "INOUT")   return PortDirection::INOUT;
...
{
  if(converter_) return converter_(str);
  return {};
}
...
bool IsAllowedPortName(StringView str)
{
  ...
  if(!std::isalpha(first_char)) return false;
